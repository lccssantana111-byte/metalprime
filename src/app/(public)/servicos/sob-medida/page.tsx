...
export default async function SobMedidaPage() {
  ...
  return (
    <>
      <ServiceHero name={service.name} tagline={service.tagline} heroImage={service.hero_image} slug="sob-medida" />
      <ServiceFeatures features={service.features} />
      <ServiceGallery serviceSlug="sob-medida" />
      <ServiceProcess />
      <ServiceQuoteForm serviceName={service.name} serviceSlug="sob-medida" />
