...
export default function ContatoPage() {
  return (
    <div className="pt-16">
            ...
            <div className="lg:col-span-4 space-y-0">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {item.href ? (
                        <a
                          ...
                          className="group flex items-center gap-2 text-sm font-medium text-white hover:text-amber-brand transition-colors"
                        >
                          {item.value}
              ...
              <div className="pt-6">
                ...
                >
                  ...
                  <div>
                    <p className="text-sm font-bold text-white">Falar pelo WhatsApp</p>
                    <p className="text-xs text-metal">Resposta imediata</p>
                  </div>
                  <ArrowUpRight className="w-4 h-4 text-metal ml-auto group-hover:text-white transition-colors" />
                </a>
              </div>
            </div>
      ...
      {/* Map placeholder */}
      <section className="h-64 bg-graphite border-t border-white/5 relative overflow-hidden">
