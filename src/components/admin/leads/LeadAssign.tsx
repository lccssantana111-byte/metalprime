  ...
  return (
    <div>
      ...
      <select
        ...
        disabled={loading}
        className="w-full bg-steel/30 border border-metal-dark/30 text-sm text-white rounded-lg px-3 py-2 focus:outline-none focus:border-amber-brand/50 disabled:opacity-50"
      >
