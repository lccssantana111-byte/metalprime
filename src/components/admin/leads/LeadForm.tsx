      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-5">
          <div className="bg-graphite border border-metal-dark/30 rounded-xl p-6 space-y-4">
            <h3 className="font-semibold text-white">Dados do contato</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <Input id="name" value={fields.name} onChange={set('name')} required
                  className="mt-1 bg-steel border-metal-dark/40 text-white" placeholder="Nome completo" />
              </div>
              <div>
                ...
                <Input id="phone" value={fields.phone} onChange={set('phone')} required
                  className="mt-1 bg-steel border-metal-dark/40 text-white" placeholder="(11) 99999-9999" />
              </div>
              <div>
                ...
                <Input id="email" type="email" value={fields.email} onChange={set('email')}
                  className="mt-1 bg-steel border-metal-dark/40 text-white" placeholder="email@empresa.com" />
              </div>
              <div>
                ...
                <Input id="company" value={fields.company} onChange={set('company')}
                  className="mt-1 bg-steel border-metal-dark/40 text-white" placeholder="Nome da empresa" />
              </div>
              <div>
                <Label htmlFor="city" className="text-metal text-sm">Cidade</Label>
                <Input id="city" value={fields.city} onChange={set('city')}
                  className="mt-1 bg-steel border-metal-dark/40 text-white" placeholder="São Paulo - SP" />
              </div>
              <div>
          ...
          <div className="bg-graphite border border-metal-dark/30 rounded-xl p-6 space-y-4">
            <h3 className="font-semibold text-white">Interesse e Observações</h3>
