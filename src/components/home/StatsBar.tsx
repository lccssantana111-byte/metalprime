...
export default function StatsBar() {
  return (
    <section
      ...
      style={{ background: '#eeeae3', borderTop: '1px solid rgba(0,0,0,0.07)', borderBottom: '1px solid rgba(0,0,0,0.07)' }}
    >
          ...
          {stats.map((stat, i) => (
            ...
            >
              <div
                ...
                style={{ fontSize: 'clamp(3rem, 6vw, 5.5rem)', color: '#1e2328', letterSpacing: '-0.03em' }}
              >
