...
export default function LineWaves({
  ...
  useEffect(() => {
    ...
    // Match section background so pre-render flash is invisible
    gl.clearColor(0, 0, 0, 0)
    const canvas = gl.canvas as HTMLCanvasElement
    canvas.style.cssText = 'position:absolute;top:0;left:0;width:100%;height:100%;display:block;background:transparent;pointer-events:none;'
    ...
    function handleMouseLeave() { targetMouse[0] = 0.5; targetMouse[1] = 0.5 }
    ...
    function resize() {
      ...
      if (program) program.uniforms.uResolution.value = [w, h, w / h]
    }
