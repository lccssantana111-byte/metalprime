...
export default function WhatsAppFAB() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => { if (window.scrollY > 400) setVisible(true) }
  ...
  const url = buildWhatsAppUrl(
    'Olá! Gostaria de solicitar um orçamento ou tirar uma dúvida.',
    WHATSAPP_NUMBER,
  )
    ...
    <AnimatePresence>
      {visible && (
        ...
        >
          ...
          >
            {/* Pulse ring */}
            <div className="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-15 scale-110" />
